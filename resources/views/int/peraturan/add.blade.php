...
<!-- Basic datatable -->
<form method="POST" action="{{ route('data.peraturan.save') }}">
	@csrf
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title">Form Tambah Data Peraturan</h5>
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input type="text" name="nama_peraturan" value="{{ old('nama_peraturan') }}" required class="form-control" placeholder="Nama Peraturan">
			</div>
			
			<div class="form-group">
				<label>Deskripsi:</label>
				<textarea rows="5" cols="5" class="form-control" placeholder="Masukkan deskripsi" name="desc_peraturan">{{ old('desc_peraturan') }}</textarea>
			</div>
