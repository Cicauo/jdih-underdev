...
<!-- Basic datatable -->
<form method="POST" action="{{ route('cms.banner.update') }}"   enctype="multipart/form-data">
	@csrf
	...
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			...
			<div class="form-group @if($errors->has('banner1')) has-error has-feedback @endif">
				<label>Banner 1 (<a target="_blank" href="{{ asset('uploads/cms/banner/ban1.png') }}">view</a>):</label>
				<input type="file" name="banner1" id="" class="form-control">
				@if ($errors->has('banner1'))
					<div class="form-control-feedback">
						<i class="icon-notification2"></i>
					</div>
					<span class="help-block">{{ $errors->first('banner1') }}</span>
				@else
					<span class="help-block">Format: image. Ukuran max file 2 Mb</span>
				@endif
			</div>
			<div class="form-group @if($errors->has('banner2')) has-error has-feedback @endif">
				<label>Banner 2 (<a target="_blank" href="{{ asset('uploads/cms/banner/ban2.png') }}">view</a>):</label>
				<input type="file" name="banner2" id="" class="form-control">
				@if ($errors->has('banner2'))
					<div class="form-control-feedback">
						<i class="icon-notification2"></i>
					</div>
					<span class="help-block">{{ $errors->first('banner2') }}</span>
				@else
					<span class="help-block">Format: image. Ukuran max file 2 Mb</span>
				@endif
			</div>
