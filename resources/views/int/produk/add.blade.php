...
<!-- Basic datatable -->
<form method="POST" action="{{ route('data.produk.save') }}"  enctype="multipart/form-data">
	@csrf
	<input type="hidden" name="file_exist" value="false" id="">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title">Form Tambah Anotasi Putusan Pengadilan</h5>
		...
		<div class="panel-body">
			...
			@endif
			<div class="form-group @if($errors->has('nama_produk')) has-error has-feedback @endif">
				<label>Nama Anotasi Putusan:</label>
				<input type="text" name="nama_produk" value="{{ old('nama_produk') }}" required class="form-control" placeholder="Nama anotasi putusan">
			...
			<div class="form-group @if($errors->has('file_produk')) has-error has-feedback @endif">
				<label>File:</label>
			...
			<div class="form-group @if($errors->has('desc_produk')) has-error has-feedback @endif">
				<label>Deskripsi:</label>
				<textarea rows="5" cols="5" class="wysihtml5 wysihtml5-min form-control" placeholder="Masukkan deskripsi" name="desc_produk">{{ old('desc_produk') }}</textarea>
