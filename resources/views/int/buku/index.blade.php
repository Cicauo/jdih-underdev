...
<!-- Basic datatable -->
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title">Data Buku</h5>
		...
		<table class="table datatable-basic">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{ route('data.buku.download', [$data->id, $data->sampul_buku] ) }}" class="btn bg-primary-400 btn-rounded btn-icon btn-xs">
							<span class="icon-image2"></span>
						</a>
					</td>
					<td>
						<a href="{{ route('data.buku.download', [$data->id, $data->daftarisi_buku] ) }}" class="btn bg-primary-400 btn-rounded btn-icon btn-xs">
							<span class="icon-image2"></span>
						</a>
					</td>
					...
					<td>
						<a href="{{ route('data.buku.edit', $data->id) }}">
							<button type="button" class="btn btn-info btn-xs"><i class="icon-pencil7"></i> Edit</button>
						</a>
					</td>
					<td>
						<a onclick="return confirm('Apakah anda benar ingin menghapus data ini?')" href="{{ route('data.buku.delete', ['id'=>$data->id]) }}">
