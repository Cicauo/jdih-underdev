...
<!-- Basic datatable -->
<form method="POST" action="{{ route('data.katalog.update') }}">
	@csrf
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title">Form Edit Data Katalog</h5>
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input type="text" name="nama_katalog" value="{{ old('nama_katalog') ?: $data->nama_katalog }}" required class="form-control" placeholder="Nama Katalog">
			</div>
			
			<div class="form-group">
				<label>Deskripsi:</label>
				<textarea rows="5" cols="5" class="form-control" placeholder="Masukkan deskripsi" name="desc_katalog">{{ old('desc_katalog') ?: $data->desc_katalog }}</textarea>
			</div>
